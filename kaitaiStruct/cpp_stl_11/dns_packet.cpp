...
void dns_packet_t::_read() {
    ...
    m_answers = std::unique_ptr<std::vector<std::unique_ptr<resource_record_t>>>(new std::vector<std::unique_ptr<resource_record_t>>());
    m_answers->reserve(l_answers);
    for (int i = 0; i < l_answers; i++) {
        m_answers->push_back(std::move(std::unique_ptr<resource_record_t>(new resource_record_t(m__io, this, m__root))));
    }
    int l_authorities = nscount();
    m_authorities = std::unique_ptr<std::vector<std::unique_ptr<resource_record_t>>>(new std::vector<std::unique_ptr<resource_record_t>>());
    m_authorities->reserve(l_authorities);
    for (int i = 0; i < l_authorities; i++) {
        m_authorities->push_back(std::move(std::unique_ptr<resource_record_t>(new resource_record_t(m__io, this, m__root))));
    }
    int l_additionals = arcount();
    m_additionals = std::unique_ptr<std::vector<std::unique_ptr<resource_record_t>>>(new std::vector<std::unique_ptr<resource_record_t>>());
    m_additionals->reserve(l_additionals);
    for (int i = 0; i < l_additionals; i++) {
        m_additionals->push_back(std::move(std::unique_ptr<resource_record_t>(new resource_record_t(m__io, this, m__root))));
    }
}
...
void dns_packet_t::resource_record_t::_read() {
    m_name = std::unique_ptr<domain_t>(new domain_t(m__io, this, m__root));
    m_type = static_cast<dns_packet_t::rr_type_t>(m__io->read_u2be());
    n_body = true;
    switch (type()) {
    case dns_packet_t::RR_TYPE_A: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_a_t>(new rr_body_a_t(m__io, this, m__root));
        break;
    }
    case dns_packet_t::RR_TYPE_DS: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_ds_t>(new rr_body_ds_t(m__io, this, m__root));
        break;
    }
    case dns_packet_t::RR_TYPE_NS: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_ns_t>(new rr_body_ns_t(m__io, this, m__root));
        break;
    }
    case dns_packet_t::RR_TYPE_KEY: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_key_t>(new rr_body_key_t(m__io, this, m__root));
        break;
    }
    case dns_packet_t::RR_TYPE_CNAME: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_cname_t>(new rr_body_cname_t(m__io, this, m__root));
        break;
    }
    case dns_packet_t::RR_TYPE_OPT: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_opt_t>(new rr_body_opt_t(m__io, this, m__root));
        break;
    }
    case dns_packet_t::RR_TYPE_RRSIG: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_rrsig_t>(new rr_body_rrsig_t(m__io, this, m__root));
        break;
    }
    case dns_packet_t::RR_TYPE_NSEC3: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_nsec3_t>(new rr_body_nsec3_t(m__io, this, m__root));
        break;
    }
    case dns_packet_t::RR_TYPE_AAAA: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_aaaa_t>(new rr_body_aaaa_t(m__io, this, m__root));
        break;
    }
    case dns_packet_t::RR_TYPE_SOA: {
        n_body = false;
        m_body = std::unique_ptr<rr_body_soa_t>(new rr_body_soa_t(m__io, this, m__root));
        break;
    }
    }
}
...
void dns_packet_t::domain_t::_read() {
    m_name = std::unique_ptr<std::vector<std::unique_ptr<word_t>>>(new std::vector<std::unique_ptr<word_t>>());
    {
        int i = 0;
        word_t* _;
        do {
            _ = new word_t(m__io, this, m__root);
            m_name->push_back(std::move(std::unique_ptr<word_t>(_)));
            i++;
...
void dns_packet_t::rr_body_rrsig_t::_read() {
    ...
    m_sign_name = std::unique_ptr<domain_t>(new domain_t(m__io, this, m__root));
...
void dns_packet_t::rr_body_cname_t::_read() {
    ...
    m_time_to_live = m__io->read_u4be();
    m_data_length = m__io->read_u2be();
    m_cname = std::unique_ptr<domain_t>(new domain_t(m__io, this, m__root));
}
...
void dns_packet_t::rr_body_aaaa_t::_read() {
    ...
    m_time_to_live = m__io->read_u4be();
    m_data_length = m__io->read_u2be();
    m_address = std::unique_ptr<ipv6_address_t>(new ipv6_address_t(m__io, this, m__root));
}
...
void dns_packet_t::rr_body_ns_t::_read() {
    ...
    m_time_to_live = m__io->read_u4be();
    m_data_length = m__io->read_u2be();
    m_name_server = std::unique_ptr<domain_t>(new domain_t(m__io, this, m__root));
}
...
void dns_packet_t::rr_body_nsec3_t::_read() {
    ...
    m_type_map = std::unique_ptr<map__t>(new map__t(m__io, this, m__root));
}
...
void dns_packet_t::rr_body_a_t::_read() {
    ...
    m_time_to_live = m__io->read_u4be();
    m_data_length = m__io->read_u2be();
    m_address = std::unique_ptr<ipv4_address_t>(new ipv4_address_t(m__io, this, m__root));
}
...
dns_packet_t::rr_body_soa_t::rr_body_soa_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent, dns_packet_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = p__root;
    m_primary_name_server = nullptr;
    m_reponsible_authority = nullptr;
    _read();
}
...
void dns_packet_t::rr_body_soa_t::_read() {
    ...
    m_time_to_live = m__io->read_u4be();
    m_data_length = m__io->read_u2be();
    m_primary_name_server = std::unique_ptr<domain_t>(new domain_t(m__io, this, m__root));
    m_reponsible_authority = std::unique_ptr<domain_t>(new domain_t(m__io, this, m__root));
