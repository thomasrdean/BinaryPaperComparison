...
public:
    ...
    public:
        ...
        map__t(kaitai::kstream* p__io, dns_packet_t::rr_body_nsec3_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        resource_record_t(kaitai::kstream* p__io, dns_packet_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        domain_t* name() const { return m_name; }
    ...
    public:
        ...
        rr_body_opt_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        rr_body_key_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        domain_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    private:
        std::vector<word_t*>* m_name;
        dns_packet_t* m__root;
        kaitai::kstruct* m__parent;

    public:
        std::vector<word_t*>* name() const { return m_name; }
        dns_packet_t* _root() const { return m__root; }
    ...
    public:
        ...
        ipv6_address_t(kaitai::kstream* p__io, dns_packet_t::rr_body_aaaa_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        rr_body_rrsig_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        domain_t* sign_name() const { return m_sign_name; }
    ...
    public:
        ...
        ipv4_address_t(kaitai::kstream* p__io, dns_packet_t::rr_body_a_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        rr_body_cname_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        uint32_t time_to_live() const { return m_time_to_live; }
        uint16_t data_length() const { return m_data_length; }
        domain_t* cname() const { return m_cname; }
        dns_packet_t* _root() const { return m__root; }
        dns_packet_t::resource_record_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        rr_body_aaaa_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        uint32_t time_to_live() const { return m_time_to_live; }
        uint16_t data_length() const { return m_data_length; }
        ipv6_address_t* address() const { return m_address; }
        dns_packet_t* _root() const { return m__root; }
        dns_packet_t::resource_record_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        rr_body_ns_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        uint32_t time_to_live() const { return m_time_to_live; }
        uint16_t data_length() const { return m_data_length; }
        domain_t* name_server() const { return m_name_server; }
        dns_packet_t* _root() const { return m__root; }
        dns_packet_t::resource_record_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        rr_body_ds_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        rr_body_nsec3_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        map__t* type_map() const { return m_type_map; }
        dns_packet_t* _root() const { return m__root; }
        dns_packet_t::resource_record_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        rr_body_a_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        uint32_t time_to_live() const { return m_time_to_live; }
        uint16_t data_length() const { return m_data_length; }
        ipv4_address_t* address() const { return m_address; }
        dns_packet_t* _root() const { return m__root; }
        dns_packet_t::resource_record_t* _parent() const { return m__parent; }
    };
    ...
    public:
        ...
        word_t(kaitai::kstream* p__io, dns_packet_t::domain_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    public:
        ...
        rr_body_soa_t(kaitai::kstream* p__io, dns_packet_t::resource_record_t* p__parent = 0, dns_packet_t* p__root = 0);
    ...
    private:
        ...
        uint32_t m_time_to_live;
        uint16_t m_data_length;
        domain_t* m_primary_name_server;
        domain_t* m_reponsible_authority;
    ...
    public:
        ...
        uint32_t time_to_live() const { return m_time_to_live; }
        uint16_t data_length() const { return m_data_length; }
        domain_t* primary_name_server() const { return m_primary_name_server; }
        domain_t* reponsible_authority() const { return m_reponsible_authority; }
...
private:
    ...
    std::vector<resource_record_t*>* m_answers;
    std::vector<resource_record_t*>* m_authorities;
    std::vector<resource_record_t*>* m_additionals;
    dns_packet_t* m__root;
    kaitai::kstruct* m__parent;
...
public:
    ...
    std::vector<resource_record_t*>* answers() const { return m_answers; }
    std::vector<resource_record_t*>* authorities() const { return m_authorities; }
    std::vector<resource_record_t*>* additionals() const { return m_additionals; }
    dns_packet_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
};
